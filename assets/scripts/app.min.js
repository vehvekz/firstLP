  ...
  (function(){
    var app = {
      ...
      setUpListeners: function () {
        $('.menu-toggle').on('click', this.toggleMenu);
        $('#play-video').on('click', this.videoPlay);
        $(window).on('resize', this.resizeEvents);
      },
      ...
      videoPlay: function (e) {
        e.preventDefault();
        var playBtn = $(this),
            overlay = playBtn.closest('.video-overlay');
        overlay.fadeOut('300');
      },
      ...
      resizeEvents: function () {
        ...
        } else if ($(window).width() <= 767 && !navToggle.hasClass('active')) {
...
function testiSlider() {
  var testiWrap = $('.testimonials-wrap');
  if(testiWrap.length) {
    testiWrap.flickity({
      setGallerySize: true,
      adaptiveHeight: true,
